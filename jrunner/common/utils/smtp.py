...
opts = [
    ...
    cfg.StrOpt(
        'auth_method',
        default='LOGIN PLAIN',
        help='SMTP authentication method'),
    cfg.StrOpt(
        'email_from',
        default='Cloudbase Job Runner <jobrunner@change.me>',
        help='Email "from" field'),
    cfg.StrOpt(
        'email_subject',
        default='[Cloudbase Job Runner] Job Status Update',
        help='Email subject'),
]
...
def send_email(to_email, subject, body,
               from_email=CONF.smtp.email_from, fail_silently=True):
    if not subject:
